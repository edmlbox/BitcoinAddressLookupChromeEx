  ...
  if (x.altKey) {
    ...
    if (testAddress) {
      ...
      sendMSG(sendThis, function(location, x) {
        ...
        sp2.innerHTML =
          '<span class="curent_bal">Current balance:</span>' +
          '<span class="classData">' +
          responded.final_balance / 100000000 +
          "</span>";
        var sp3 = document.createElement("span");
        sp3.id = "N_tx";
        sp3.style.flex = "1 0 100%";
        sp3.innerHTML =
          '<span class="curent_bal">Total received:</span>' +
          '<span class="classData">' +
          responded.total_received / 100000000 +
          "</span>";
        var sp4 = document.createElement("span");
        sp4.id = "totalReceived";
        sp4.style.flex = "1 0 100%";
        sp4.innerHTML =
          '<span class="curent_bal">Total sent:</span>' +
          '<span class="classData">' +
          responded.total_sent / 100000000 +
          "</span>";
        var sp5 = document.createElement("span");
        sp5.id = "totalSent";
        sp5.style.flex = "1 0 100%";
        sp5.innerHTML =
          '<span class="curent_bal">Number of tx:</span>' +
          '<span class="classData">' +
          responded.n_tx +
          "</span>";
